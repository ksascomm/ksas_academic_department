...
<?php
	...
	$course_curl->get(
		...
		function( $result ) use ( &$output ) {
			...
			$roomnumber_aux      = $result->body[0]->{'SectionDetails'}[0]->{'Meetings'}[1]->{'Room'};
