							...
							<div class="cell testimonial-container">
									...
									<div class="testimonial-bio">
											...
											<?php if ( get_post_meta( $post->ID, 'ecpt_internship', true ) ) : ?>
													<p><?php echo esc_html( get_post_meta( $post->ID, 'ecpt_internship', true ) ); ?></p>
											<?php endif; ?>
											<?php if ( get_post_meta( $post->ID, 'ecpt_class', true ) ) : ?>
													<p>Class of <span class="light"><?php echo esc_html( get_post_meta( $post->ID, 'ecpt_class', true ) ); ?></span></p>
											<?php endif; ?>
									</div>
