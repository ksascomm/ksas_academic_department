...
// Load Zebra Curl
	...
	// Course display callback function
		function display_courses( $result ) {
			...
			echo '<td><button class="button course-details" data-open="course-' . $clean_course_number . $section_number . $clean_term . '">More Info<span class="show-for-sr">-'.$title. '-' . $section_number.'</span></button></td></tr>';
	...
	// ISIS Call callback function
		...
		//$cache_dir = get_template_directory() . '/assets/functions/cache/';
    ...
    <div class="main-grid">
        <main class="main-content">
			...
			<ul class="tabs" data-tabs id="courses-tabs">
				...
				<li class="tabs-title"><a href="#Spring">Spring 2021</a></li>
			</ul>
