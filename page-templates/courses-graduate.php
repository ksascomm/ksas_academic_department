...
// Load Zebra Curl
	...
	// Course display callback function
		function display_courses( $result ) {
			...
			echo '<td><button class="button course-details" data-open="course-' . $clean_course_number . $section_number . $clean_term . '">More Info<span class="show-for-sr">-'.$title.'</span></button></td></tr>';
