			...
			<div class="orbit-wrapper">	
                ...
                while ($slider_query->have_posts() ) : $slider_query->the_post(); $slidernumber++;?>
					...
					<li class="orbit-slide">	
						<img class="orbit-image hide-for-print" src="<?php echo get_post_meta($post->ID, 'ecpt_slideimage', true); ?>" alt="<?php $the_content = get_the_content(); if ( !empty($the_content) ) { echo $the_content; } else { echo 'Homepage Slider'; };?>">
