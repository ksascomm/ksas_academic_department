		...
		<div class="media-object-section">
			...
			<ul class="contact">
				...
				<?php if ( get_post_meta( $post->ID, 'ecpt_leave', true ) ) : ?>
					<li><span class="fa-solid fa-calendar-circle-exclamation" aria-hidden="true"></span> <span class="leave-note"><strong>On Leave:</span> <?php echo esc_html( get_post_meta( $post->ID, 'ecpt_leave', true ) ); ?></strong></li>
				<?php endif; ?>
