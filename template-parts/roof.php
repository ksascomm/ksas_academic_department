...
<div class="off-canvas position-top" id="offCanvasTop1" data-off-canvas aria-hidden="true">
	...
	<h1 class="show-for-sr">Explore JHU</h1>
		...
		<div class="cell">
			...
			<ul class="vertical menu" role="menu">
				<li role="menuitem"><a href="https://sis.jhu.edu/sswf/" onclick="ga('send', 'event', 'Offcanvas', 'Resources', 'SIS')">Course Listings & Registration</a></li>
				...
				<li role="menuitem"><a href="https://policies.jhu.edu/" onclick="ga('send', 'event', 'Offcanvas', 'Resources', 'Registrars')">University Policies & Document Library <span class="fas fa-sign-in-alt"></span></a></li>	
			</ul>
		</div>
		<div class="cell">
			<h2>Across Campus</h2>
