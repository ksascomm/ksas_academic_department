	...
	<div class="tribe-block tribe-block__events-link">
		<?php if ( $has_google_cal ) : ?>
			<div class="tribe-block__btn--link tribe-block__events-gcal">
				...
				>
				<i class="fa-brands fa-google"></i> <?php echo esc_html( $this->attr( 'googleCalendarLabel' ) ) ?>
				</a>
			</div>
		<?php endif; ?>
		<?php if ( $has_ical ) : ?>
			<div class="tribe-block__btn--link tribe-block__-events-ical">
				...
				>
				<i class="fa-solid fa-calendar-days"></i> <?php echo esc_html( $this->attr( 'iCalLabel' ) ); ?>
				</a>
			</div>
		<?php endif; ?>
	</div>
