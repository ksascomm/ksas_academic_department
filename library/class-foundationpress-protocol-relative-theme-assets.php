...
if ( ! class_exists( 'Ksasacademic_Protocol_Relative_Theme_Assets' ) ) :
	class Ksasacademic_Protocol_Relative_Theme_Assets {
		/**
	...
	$ksasacademic_protocol_relative_theme_assets = new Ksasacademic_Protocol_Relative_Theme_Assets();
endif;
