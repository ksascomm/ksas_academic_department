...
// add hook
add_filter( 'wp_nav_menu_objects', 'my_wp_nav_menu_objects_sub_menu_children', 10, 2 );
// filter_hook function to react on sub_menu flag
function my_wp_nav_menu_objects_sub_menu_children( $sorted_menu_items, $args ) {
  if ( isset( $args->sub_menu_children ) ) {
		$current_id = 0;
		$root_id = 0;
